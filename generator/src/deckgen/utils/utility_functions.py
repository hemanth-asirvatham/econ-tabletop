        ...
        cards.append(
            {
                ...
                "description": "A pragmatic policy option that shifts visible economic outcomes.",
                "category": slot["category"],
                "cost": {
                    "budget_cost": 2,
                    "notes": "Moderate cost with visible tradeoffs.",
                },
...
def dummy_image_outline() -> str:
    return "\n".join(
        [
            ...
            "- Policy cards: no stage/arrows; bottom row with Cost, Time, Impact, Category labels.",
    ...
    *,
        ...
        stage_lines.append(
            "\n".join(
                [
                    ...
                    "- What everyday life feels like: services improve unevenly while hiring patterns start to shift.",
                    "- Policy focus:",
                    ...
                    "  - Labor-market shifts",
                    "  - Energy and service constraints",
                    "- Power dynamics:",
    ...
    return "\n".join(
        [
            ...
            "- Policy: no stage/arrows; bottom row with Cost, Time, Impact, Category labels.",
            "",
